const resetMailer = require("../mailers/forgot_password_mailer");
//const fpassWord  = require("../views/mailers");
const queue = require("../config/kue");
const resetEmailWorker = require("../workers/reset_email_worker");
const User = require("../models/users");
const Reset = require("../models/reset-pass");
const crypto = require("crypto");

module.exports.getEmail = function (req, res) {
  return res.render('../views/mailers/forgotpw/forgot_password.ejs', {
